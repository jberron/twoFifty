...
if (!$found)
{
  foreach ($permutations as $permutation)
  {
    ...
    if ((int)$permutation >= 100 && (int)$permutation <= $maxNumber && substr_count($randomString, $permutation) < 1) { $found = true; echo 'The missing number is: ' . $permutation. ' because there is no occurrences and the number is greater or equal than 100<br><br>'; break;}
  }      
}
